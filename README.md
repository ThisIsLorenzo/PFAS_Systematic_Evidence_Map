...
## /R/
In this folder, we stored files providing deduplication code, analysis code, and Shiny app developmental code (URL to access our Shiny app: https://hi-this-is-lorenzo.shinyapps.io/PFAS_SEM_Shiny_App/).
...
### /PFAS_SEM_Shiny_App/
- ```/data```: same data folder of ```PFAS_Systematic_Evidence_Map/data```. It needs to be here to make the Shiny app work.
- ```/rsconnect```: IGNORE, Shiny app deployment related.
- ```/shiny_app_code.R```: script code for Shiny app.

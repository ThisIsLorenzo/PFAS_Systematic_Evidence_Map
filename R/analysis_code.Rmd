...
networkPlot_modified <- 
  function (NetMatrix, normalize = NULL, n = NULL, degree = NULL, 
    ...
    edgesize = 1, edges.min = 0, alpha = 0.5, verbose = TRUE) 
{
    ...
    V(bsk.network)$color <- adjustcolor(V(bsk.network)$color, 
        alpha)
    V(bsk.network)$label.color <- "black"
...
NetMatrix_keywords_plot <- 
  networkPlot_modified(NetMatrix_keywords,
...
NetMatrix_keywords_plot2 <- 
  networkPlot(NetMatrix_keywords2,
              normalize = "association",
              n = 20,
              Title = "Keyword co-occurrences",
              type = "fruchterman",

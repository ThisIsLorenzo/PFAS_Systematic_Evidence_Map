      ...
      tabItem(tabName = "data",
              tabBox(id = "t1", width = 12,
                     ...
                     tabPanel(title = "Summary Stats", icon = icon("chart-pie"),
                              tabsetPanel(
                                tabPanel("Mapping", verbatimTextOutput("summary1"), verbatimTextOutput("summary1.1")),
                                tabPanel("Appraisal", verbatimTextOutput("summary2")),
                                tabPanel("Bibliometrics", verbatimTextOutput("summary3"))
                                )
                              ),

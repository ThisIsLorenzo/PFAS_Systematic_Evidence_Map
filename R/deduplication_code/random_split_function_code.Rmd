...
set.seed(123)
# split
rand_split_list <- random_split(articles, 2, p=c(1/2,1/2))
split1 <- data.frame(rand_split_list[1])
split2 <- data.frame(rand_split_list[2])

# save files
write_csv(split1, here("data/update/allreviews_abstit_split1.csv", na=""))
write_csv(split2, here("data/update/allreviews_abstit_split2.csv", na=""))
```
